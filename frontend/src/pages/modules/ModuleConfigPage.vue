...
const listFieldCount = computed(
  () => fields.value.filter((f) => f.show_in_list && f.visible).length,
)
...
<template>
  <PageContainer>
    ...
    <template v-if="module">
      ...
      <FieldListingTransfer
        v-if="activeTab === 'listing'"
        v-model:fields="fields"
        :max-displayed="MAX_LIST_FIELDS"
      />
